...
Goes without saying, we're also ready for JDK 16, which is about to be released. If you find issues with JDK 16 it might be a bit late, but let us know anyway.

== Fixes

Some other minor defects have been fixed, for a full list see https://hibernate.atlassian.net/secure/ReleaseNote.jspa?version=31904&styleName=Html&projectId=10031[the Release Notes].
